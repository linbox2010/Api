...
function drawCylinder(locateX, locateY, color, path, focus) {
    ...
    if (focus) {
        color = 0x202020; //color of the focus piece
    }
    const material = [
...
function move1step(piece, direction) {
    if (direction == "up" && piece.position.z > -150) {
        piece.position.z -= 50;
    } else if (direction == "down" && piece.position.z < 150) {
        piece.position.z += 50;
    } else if (direction == "left" && piece.position.x > -200) {
        piece.position.x -= 50;
    } else if (direction == "right" && piece.position.x < 150) {
        piece.position.x += 50;
    }
...
const focusPiece = drawSquare(0xffffff);
